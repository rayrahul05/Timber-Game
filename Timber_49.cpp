...
int main()
{
    ...
    float beeSpeed=0.0f;
    float beeAmplitude = 100.0f;
    float beeBaseHeight = 600.0f;
    ...
    SoundBuffer chopBuffer;      //texture for soundBuffer
    chopBuffer.loadFromFile("sound/chop.wav");
    Sound chop;                 // sprite for sound
    ...
    while (window.isOpen())
    {
       ...
       else
        {
            ...
            float newY = beeBaseHeight + sin(newX * 0.01f) * beeAmplitude;
        ...
        }else
        {
            ...
            if(!paused && branchPosition[5] == playerSide){
